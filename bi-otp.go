...
func (dt *BIOtp) Name() string {
	return "bi_otp"
}

// HTMLTemplate returns a Golang template that will generate an HTML email.
func (dt *BIOtp) HTMLTemplate() string {
	return `
<!DOCTYPE html>
<html lang="en">
	...
	<div class="container-content" style="max-width:910px;margin:auto">
		<div class="container" style="max-width:800px;margin:auto;color:#333333">
			...
			<div style="width:95%;padding:10px;text-align: center;">
				 <p style="color:#646464; font-size:18px; font-weight:bold">Verification Code</p>
         <p style="color:#c9174e; font-size:24px; font-weight:bold">{{ .Email.Body.Registration.OTP }}</p>
         <p style="font-size:12px; color:#333333
">{{ .Email.Body.Registration.Help }}</p>
			</div>
...
func (dt *BIOtp) PlainTextTemplate() string {
