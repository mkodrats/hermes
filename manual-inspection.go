...
// Flat is a theme
type ManualInspection struct{}

// Name returns the name of the flat theme
func (dt *ManualInspection) Name() string {
	return "manual_inspection"
}

// HTMLTemplate returns a Golang template that will generate an HTML email.
func (dt *ManualInspection) HTMLTemplate() string {
	return `
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class="container-content">
		<div class="container">
			...
			<div class="email"><p>Email Address : {{ .Email.Body.Registration.EmailAddress }}<p></div>
...
func (dt *ManualInspection) PlainTextTemplate() string {
