...
func (dt *TemporaryPassword) Name() string {
	return "temporary_password"
}

// HTMLTemplate returns a Golang template that will generate an HTML email.
func (dt *TemporaryPassword) HTMLTemplate() string {
	return `
<!DOCTYPE html>
<html lang="en">
...
<body>
	<div class="container-content">
		<div class="container">
			...
			<p>{{ .Email.Body.Registration.Help }}</p>
			<div class="signature">
				<p>Best Regards,</p>
...
func (dt *TemporaryPassword) PlainTextTemplate() string {
