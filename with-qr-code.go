...
// Flat is a theme
type WithQRCode struct{}

// Name returns the name of the flat theme
func (dt *WithQRCode) Name() string {
	return "with_qr_code"
}

// HTMLTemplate returns a Golang template that will generate an HTML email.
func (dt *WithQRCode) HTMLTemplate() string {
	return `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta http-equiv="QRCode-Type" content="text/html; charset=UTF-8" />
                  ...
                  <td class="content-cell">
                    ...
                    {{ else }}
                      ...
                      {{ with .Email.Body.Table }}
                        ...
                        {{ end }}
                      {{ end }}
					  {{ if .Email.Body.QRCode }}
						<img class="qr-image" src="{{ .Email.Body.QRCode | url}}">
					  {{ end }}
                      <!-- Action -->
...
func (dt *WithQRCode) PlainTextTemplate() string {
